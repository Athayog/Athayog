                ...
                >
                    {GALLERY_ITEMS.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <Image src={item.image} alt={item.title} fill sizes="(max-width: 600px) 50vw, (max-width: 900px) 33vw, 25vw" style={{ objectFit: 'cover' }} loading="lazy" />
                            </Box>
