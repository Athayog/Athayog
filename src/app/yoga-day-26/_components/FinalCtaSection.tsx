    ...
    return (
        <Box component="section" sx={{ py: { xs: 8, md: 14 }, bgcolor: '#2b3524', textAlign: 'center' }}>
            <Container maxWidth="lg">
                <Typography sx={{ display: 'block', fontSize: '0.75rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.7)', mb: '0.5rem', fontWeight: 500 }}>
                ...
                <Typography sx={{ color: 'rgba(255,255,255,0.75)', maxWidth: 460, mx: 'auto', mb: '2.5rem', fontSize: '0.94rem', lineHeight: 1.6 }}>
