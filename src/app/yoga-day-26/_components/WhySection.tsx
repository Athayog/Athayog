...
const WHY_ICONS: Record<string, React.ReactNode> = {
    heart: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4f6148" strokeWidth="1.5">
                        ...
                        <Box key={item.title} sx={{ 
                            ...
                            <Box
                                ...
                                sx={{
                                    ...
                                    height: 48,
                                    borderRadius: '50%',
                                    bgcolor: 'rgba(79, 97, 72, 0.08)',
                                    mb: '1.2rem',
                                    border: '1px solid rgba(79, 97, 72, 0.12)',
                                    transition: 'all 0.3s ease-out',
                                }}
                            >
                                {WHY_ICONS[item.icon]}
                            </Box>
                            <Typography variant="h3" sx={{ color: '#3d2f1e', mb: '0.75rem', fontSize: '1.15rem', fontWeight: 600, fontFamily: 'var(--font-inter)' }}>
                                {item.title}
                            </Typography>
