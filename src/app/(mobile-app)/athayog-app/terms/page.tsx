            ...
            <Box sx={{ maxWidth: '1440px', margin: '0 auto' }}>
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            This mobile application is operated by Athayog
                            Living. Throughout the site, the terms “we”, “us”
                            and “our” refer to Athayog Living. Athayog Living
                            offers this mobile application, including all
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            accessing or using our mobile application. By
                            ...
                            agreement, then you may not access the mobile
                            application or use any services. If these Terms of
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            and/or changes to our mobile application. It is your
                            responsibility to check this page periodically for
                            changes. Your continued use of or access to the
                            mobile application following the posting of any
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            on the mobile application through which the service
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            exclusively online through the mobile application.
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            For more detail, please review our Returns/Refund
                            Policy.
                        </Typography>
                    </Stack>
                </Box>
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            and/or features through the mobile application
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            third-party mobile applications that are not
                            ...
                            mobile applications, or for any other materials,
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            connection with any third-party mobile applications.
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            otherwise (collectively, &apos;comments&apos;), you
                            agree that we may, at any time, without restriction,
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            related mobile application. You may not use a false
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            the Service or on any related mobile application is
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            mobile application, including without limitation,
                            pricing information, except as required by law. No
                            specified update or refresh date applied in the
                            Service or on any related mobile application, should
                            be taken to indicate that all information in the
                            Service or on any related mobile application has
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            or operation of the Service or of any related mobile
                            application, other mobile applications, or the
                            Internet; (h) to collect or track the personal
                            information of others; (i) to spam, phish, pharm,
                            pretext, spider, crawl, or scrape; (j) for any
                            obscene or immoral purpose; or (k) to interfere with
                            or circumvent the security features of the Service
                            or any related mobile application, other mobile
                            applications, or the Internet. We reserve the right
                            to terminate your use of the Service or any related
                            mobile application for violating any of the
                            prohibited uses.
                        </Typography>
                    </Stack>
                </Box>
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            In no case shall Athayog Living our directors,
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            Athayog Living and our parent, subsidiaries,
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            and jurisdiction of Bengaluru, Karnataka
                        </Typography>
                    </Stack>
                </Box>
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            Service by posting updates and changes to our mobile
                            application. It is your responsibility to check our
                            mobile application periodically for changes. Your
                            continued use of or access to our mobile application
                            or the Service following the posting of any changes
                            to these Terms of Service constitutes acceptance of
                            those changes.
                        </Typography>
                    </Stack>
                </Box>
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            to us at info@athayogliving.com.
                        </Typography>
                    </Stack>
                </Box>
            </Box>
