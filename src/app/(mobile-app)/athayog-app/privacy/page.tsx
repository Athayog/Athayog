            ...
            <Box sx={{ maxWidth: '1440px', margin: '0 auto' }}>
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            When you browse our mobile application, we also
                            automatically receive your computer’s internet
                            protocol (IP) address in order to provide us with
                            information that helps us learn about your browser
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            Once you leave our store’s mobile application or are
                            redirected to a third-party website or application,
                            you are no longer governed by this Privacy Policy or
                            our mobile application’s Terms of Service.
                        </Typography>
                        <Typography
                            sx={{ fontSize: '18px', fontWeight: '700' }}
                        >
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        <Typography sx={{ fontSize: '18px' }}>
                            ...
                            their posting on the mobile application. If we make
                            material changes to this policy, we will notify you
                            here that it has been updated, so that you are aware
                            of what information we collect, how we use it, and
                            under what circumstances, if any, we use and/or
                            disclose it.
                        </Typography>
                        <Typography sx={{ fontSize: '18px' }}>
