            ...
            <Box sx={{ maxWidth: '1440px', margin: '0 auto' }}>
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            When you browse our mobile application, we also automatically receive your computer’s internet protocol (IP) address in order to provide us with information that helps us
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            Our payment gateway adheres to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, MasterCard,
                            American Express and Discover.
                        </Typography>
                        <Typography sx={{ fontSize: '18px' }}>PCI-DSS requirements help ensure the secure handling of credit card information by our store and its service providers.</Typography>
                ...
                <Box sx={{ padding: ' 20px 0px' }}>
                    ...
                    <Stack gap="15px" marginTop="20px">
                        ...
                        <Typography sx={{ fontSize: '18px' }}>
                            In particular, remember that certain providers may be located in or have facilities that are located in a different jurisdiction than either you or us. So if you elect to
                            proceed with a transaction that involves the services of a third-party service provider, then your information may become subject to the laws of the jurisdiction(s) in
                            which that service provider or its facilities are located.
                        </Typography>
                        <Typography sx={{ fontSize: '18px' }}>
                            Once you leave our store’s mobile application or are redirected to a third-party website or application, you are no longer governed by this Privacy Policy or our mobile
                            application’s Terms of Service.
                        </Typography>
                        <Typography sx={{ fontSize: '18px', fontWeight: '700' }}>Links</Typography>
                        <Typography sx={{ fontSize: '18px' }}>
                            When you click on links on our store, they may direct you away from our site. We are not responsible for the privacy practices of other sites and encourage you to read
