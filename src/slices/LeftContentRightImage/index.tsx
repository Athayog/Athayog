 ...
 */
export type LeftContentRightImageProps = SliceComponentProps<Content.LeftContentRightImageSlice>

/**
 * Component for "LeftContentRightImage" Slices.
 */
const LeftContentRightImage = ({ slice }: LeftContentRightImageProps): JSX.Element => {
    return (
